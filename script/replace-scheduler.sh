...
echo "Step 3: Building new karmada-scheduler image..."
# 删除本地镜像
docker rmi $IMAGE_NAME 2>/dev/null || true

# 构建新镜像
make image-karmada-scheduler VERSION=$IMAGE_TAG

echo "Loading $IMAGE_NAME to cluster: karmada-host"
kind load docker-image $IMAGE_NAME --name karmada-host

echo "Step 5: Deploying new scheduler..."
# 直接应用部署文件
...
echo "✅ Scheduler replacement completed successfully!"