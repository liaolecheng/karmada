...
func (in *ComponentReplicaResourceRequirement) DeepCopyInto(out *ComponentReplicaResourceRequirement) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentReplicaResourceRequirement.
func (in *ComponentReplicaResourceRequirement) DeepCopy() *ComponentReplicaResourceRequirement {
	if in == nil {
		return nil
	}
...
func (in *ResourceInterpreterResponse) DeepCopyInto(out *ResourceInterpreterResponse) {
	*out = *in
	...
	if in.Components != nil {
		...
		*out = make([]v1alpha2.ComponentRequirements, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
